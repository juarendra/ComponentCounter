...
- Own the entire technical pipeline end-to-end (including ML training, Colab scripts, model export) and deliver only the final product (APK/build artifact) to the user. Never delegate execution steps to the user — find solutions to run everything yourself. Confidence: 0.88
